...
void display_frommatrix(volatile unsigned char matris[8][32]);
void display_frommatrixinv(volatile unsigned char matris[8][32]);
uint8_t spi_send_recv(uint8_t data);
void display_background(const uint8_t *background);

/*Declare matrix checking functions*/
int game_over(volatile unsigned char matrix[8][32]);
